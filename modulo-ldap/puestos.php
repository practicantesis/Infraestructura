    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="titulo-nombre">
                <h1 class="dm">Puesto Asignado</h1>
            </div>
            <div class="titulo-imagen"> <img class="pitic" src="./img/supply.png" alt=""></div>
        </div>
    ...
    <article class="tabla">
       ...
       // require_once('../php/funciones_generales.php');
        ...
        if ($con) {
            ...
            echo '<thead class="encabezado2"><th>Usuario</th><th>Nombre</th><th>N° Empleado</th><th>Oficina</th><th>Puesto</th></tr></thead>';
            $filter = "(uid=*)";
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                echo '<td>' . $info[$i]['noempleado'][0] . '</td>';
