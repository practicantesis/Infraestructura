...
MTY";
	...
	<div class="menu-grid">
		<?php
		if ($ofi == "Sistemas") {
			echo "<div class='enlaces-grid'>";
			echo "<button class='link' onclick='javascript:abrirdirectorio()'>Directorio</button>";
			echo "<a class='link' href='celular.php'>Celulares</a>";
			echo "<a class='link' href='usuarios.php'>Usuarios</a>";
			echo "<a class='link' href='bajas2.php'>Bajas</a>";
			echo "</div>";
		...
		if ($con) {
			...
			for ($i = 0; $i < $count; $i++) {
				...
				if (
					...
					echo '<tbody class="tabladato"><tr class="tr-body"><td>' . $num . '</td>';
