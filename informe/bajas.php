...
<body>
	...
	<div class="menu-grid">
		<div class="enlaces-grid">
			...
			<div><a class='link' href='http://ti.tpitic.com.mx/INFRAESTRUCTURA-PRODUCCION/Infraestructura/informe/index.php?666U2lzdGVtYXM=897'><button class='directorio'>Inicio</button></a></div>
			
		</div>
		<div class="actualizar-grid">
		<a class='link' href='http://ti.tpitic.com.mx/INFRAESTRUCTURA-PRODUCCION/Infraestructura/informe/bajas2.php'><button class='directorio'>actualizar</button></a>
		</div>
