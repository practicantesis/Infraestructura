...
function SaveMacChange(tipo) {
  ...
  if (re.test(va)) {
    console.log("Valid Mac");
        ...
        //alert(va);
        if (va != "NO") {
            alert("INVALID MAC VALUE, este mensaje no aplica si se escogio la mac desde el combo de OCS, si ves este mensaje, por favor toma un screenshot y mandalo a jferia -"+va+"-");
