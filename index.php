        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="moduloldap">
                            <form action="http://infr2.tpitic.com.mx/modulo-ldap/log_captura.php" method="POST" target="_blank">
                    ...
                    <li>
                        <a>
                            <form action="http://infr2.tpitic.com.mx/modulo-sql/log_captura.php" method="POST" target="_blank">
                                <input type="hidden" name="infra" value="<?php echo $_SESSION['user']; ?>">
